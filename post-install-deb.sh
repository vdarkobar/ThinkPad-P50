...
# post-install-deb.sh
# Debian 13  installer/initializer for ThinkPad P50 Validity VFS7500
...
#   sudo ./post-install-deb.sh
#
# Optional:
#   sudo ./post-install-deb.sh --yes
#   sudo ./post-install-deb.sh --skip-init
#   sudo ./post-install-deb.sh --skip-tod-libfprint
#   sudo ./post-install-deb.sh --skip-pam
#
